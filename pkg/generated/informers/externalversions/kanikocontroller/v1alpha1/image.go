...
import (
	...
	kanikocontrollerv1alpha1 "autovia.io/kaniko-controller/pkg/apis/kanikocontroller/v1alpha1"
	versioned "autovia.io/kaniko-controller/pkg/generated/clientset/versioned"
	internalinterfaces "autovia.io/kaniko-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "autovia.io/kaniko-controller/pkg/generated/listers/kanikocontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KanikocontrollerV1alpha1().Images(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KanikocontrollerV1alpha1().Images(namespace).Watch(context.TODO(), options)
			},
		},
		&kanikocontrollerv1alpha1.Image{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kanikocontrollerv1alpha1.Image{}, f.defaultInformer)
}
